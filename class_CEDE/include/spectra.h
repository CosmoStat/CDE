...
struct spectra {
  ...
  /* NEW */
  double sigma12;    /**< sigma12 parameter */
  /* */
  ...
  /* NEW */
  int index_tr_delta_tot_no_scf;  /**< index of total matter density transfer function. It includes the contribution of all the species (b+cdm+neutrinos+photons), but the scalar field */
  /**/
